...
export function FooterSection() {
  ...
  const socialLinks = [
    {
      icon: (
        <div className="relative w-7 h-7 bg-[url(/combined-shape.svg)] bg-[100%_100%]">
          <img
            className="absolute w-1 h-[5px] top-3 left-[13px]"
            alt="Fill"
    ...
    { icon: <GithubIcon className="w-7 h-7 text-white" />, href: "#" },
    {
      icon: (
        <div className="relative w-[29px] h-7 bg-[url(/combined-shape-2.svg)] bg-[100%_100%]">
          <div className="relative w-[13px] h-3 top-2 left-2 bg-[url(/combined-shape-3.svg)] bg-[100%_100%]">
            <img
              className="absolute w-[5px] h-[5px] top-1 left-1"
              alt="Shape"
    ...
    {
      icon: (
        <div className="relative w-7 h-7 bg-[url(/combined-shape-4.svg)] bg-[100%_100%]" />
      ),
      href: "#",
    },
  ];
  ...
  return (
    <footer className="w-full bg-[#18003e] py-16 px-28">
  ...
  <path d="M90.0712 11.2379C91.9209 11.2379 93.4895 11.8967 94.777 13.2143C96.0646 14.5139 96.7083 16.1835 96.7083 18.2231C96.7083 20.2266 96.0736 21.8872 94.8042 23.2048C93.5348 24.5225 91.9662 25.1813 90.0984 25.1813C88.5026 25.1813 87.1969 24.6939 86.1814 23.7192V24.9105H81.8292V5.95834H86.1814V12.6728C87.1788 11.7162 88.4754 11.2379 90.0712 11.2379ZM89.2008 21.4179C90.0349 21.4179 90.7422 21.1291 91.3225 20.5515C91.9028 19.9559 92.1929 19.1797 92.1929 18.2231C92.1929 17.2484 91.9028 16.4723 91.3225 15.8947C90.7603 15.2991 90.0531 15.0012 89.2008 15.0012C88.3303 15.0012 87.6049 15.2991 87.0246 15.8947C86.4625 16.4723 86.1814 17.2484 86.1814 18.2231C86.1814 19.1797 86.4625 19.9559 87.0246 20.5515C87.6049 21.1291 88.3303 21.4179 89.2008 21.4179Z" fill="white"/>
        ...
        {/* Tagline */}
        <div className="text-white mb-10 font-body-16 max-w-[289px]">
        ...
        {/* Description */}
        <div className="text-xs text-[#FFFFFF99] mb-12 max-w-[1216px]">
        ...
        <div className="flex justify-between items-center">
          <div className="text-sm text-[#FFFFFF99]">© 2024 YeaHub</div>
          <div className="flex items-center gap-2">
            <a href="#" className="text-white">
              <FigmaIcon className="w-5 h-5" />
            </a>
            <a href="#" className="text-white">
              <GithubIcon className="w-[29px] h-7" />
            </a>
          </div>
        </div>
      </div>
